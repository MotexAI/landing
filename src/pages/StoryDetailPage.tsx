        ...
        <article className="max-w-4xl mx-auto px-6">
          ...
          <motion.header
            ...
            <div className="flex items-center gap-4 mb-6">
              <span className="text-xs font-medium text-[#5A8BE0] bg-[#1D49A7]/10 px-3 py-1.5 rounded">
                {story.category}
              </span>
            ...
            <div className="flex items-center gap-4">
              <img
                ...
                className="w-14 h-14 rounded-full object-cover ring-2 ring-[#1a2840]" />
          ...
          <motion.div
            ...
            <div className="aspect-[2/1] rounded-2xl overflow-hidden bg-[#0d1424] border border-[#1a2840]">
              <img
                src={story.image}
                alt={story.title}
          ...
          <motion.div
            ...
            className="border-t border-b border-[#1a2840] py-8 mb-16">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-10 h-10 rounded-lg bg-[#0d1424] border border-[#1a2840] flex items-center justify-center text-gray-500 hover:text-white hover:border-[#1D49A7]/50 transition-all"
          ...
          <motion.div
            ...
            className="p-8 md:p-10 rounded-2xl bg-gradient-to-b from-[#0d1424] to-[#080e1a] border border-[#1a2840] mb-16">
                  ...
                  <motion.article
                    ...
                    <Link
                      ...
                      <div className="p-6 flex flex-col flex-grow">
                        ...
                        <h3 className="text-lg font-medium text-white mb-2 group-hover:text-[#5A8BE0] transition-colors line-clamp-2">
                          {relatedStory.title}
                        </h3>
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-[#1a2840]">
