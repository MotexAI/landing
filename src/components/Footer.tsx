  ...
  return (
    <footer className="bg-[#080e1a] border-t border-[#1a2840]/50">
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="w-9 h-9 rounded-lg bg-[#0d1424] border border-[#1a2840] flex items-center justify-center text-gray-600 hover:text-white hover:border-[#1D49A7]/50 transition-all duration-300"
              aria-label="LinkedIn">
        ...
        {/* Bottom */}
        <div className="mt-16 pt-8 border-t border-[#1a2840]/50 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-600">
