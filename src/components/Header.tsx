...
export function Header() {
  ...
  return (
    <motion.header
      ...
      className="fixed top-0 left-0 right-0 z-50 bg-[#080e1a]/80 backdrop-blur-md border-b border-[#1a2840]/50">

      <div className="max-w-6xl mx-auto px-6">
        <nav className="flex items-center justify-between h-16" aria-label="Main navigation">

          {/* Logo */}
          <Link to={langPrefix} className="flex items-center gap-2.5" aria-label="Motex home">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link
              ...
              className="text-sm font-medium text-white bg-[#1D49A7] hover:bg-[#163a86] px-5 py-2.5 rounded-lg transition-all duration-300 hover:shadow-[0_0_20px_rgba(29,73,167,0.35)]">
              {t.nav.tryDemo}
            </Link>
          </div>
        ...
        {mobileMenuOpen && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className="md:hidden py-4 border-t border-[#1a2840]">
            <div className="flex flex-col gap-1">
              ...
              <div className="pt-4 mt-2 border-t border-[#1a2840]">
                <Link
                  to={`${langPrefix}/contact`}
                  onClick={() => {
                    setMobileMenuOpen(false);
                  ...
                  className="block px-4 py-3 text-sm font-medium text-white bg-[#1D49A7] hover:bg-[#163a86] rounded-lg transition-colors text-center">
                  {t.nav.tryDemo}
                </Link>
              </div>
            </div>
